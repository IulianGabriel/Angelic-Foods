        ...
        <div className="top-footer">
          <div className="about-us">
            ...
            <p className="aboutUs-text">
              At Angelic Food, we blend flavors from around the world into our
              own unique culinary creations. With our special preparation
              methods and a wide variety of quality ingredients, each dish is a
              delightful fusion of tastes. Come savor the difference at Angelic
              Food, where every bite is a delicious adventure.
            </p>
          </div>
